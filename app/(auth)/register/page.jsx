export default function Register(){
    return(
        <>
            ...
            <input type="text" className="border-gray-300 border rounded-lg mt-1 h-10 p-2 transition-all duration-300 focus:ring-2 focus:border-purple-500 focus:ring-purple-500 focus:outline-none" placeholder="John Doe"></input>
            ...
            <button className="bg-gradient-to-r from-purple-600 to-fuchsia-600  rounded-lg text-sm text-white mt-5 h-10 font-semibold">Create Account</button>
        </>
    )
}