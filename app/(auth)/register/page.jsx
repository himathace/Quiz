...
export default function Register(){
    ...
    return(
        <>
            ...
            <input type="text" className="border border-gray-300 rounded-lg mt-1 h-10 p-2 transition-all duration-300 focus:ring-2 focus:border-purple-500 focus:ring-purple-500 focus:outline-none " placeholder="**********" name="password" onChange={(e)=>setpassword(e.target.value)} value={password}></input>
