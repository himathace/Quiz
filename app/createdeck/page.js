    ...
    return(
        ...
        <form action={ADDnewDeck}>
            ...
            <div className="flex flex-col mt-16 justify-center items-center">
                <div className=" shadow-lg bg-white border border-gray-200 rounded-xl p-5 w-2/6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="text" className="h-12 rounded-lg border-2 focus:outline-none focus:border-purple-700 border-slate-200 focus:ring-blue-500/20 transition-all duration-200 pl-3 mb-3" placeholder="Enter a name for your deck" name="deckname"></input>
                    </div>
                    <div className="flex flex-col">
                        <label className="text-sm font-medium text-slate-700 mb-3">Description</label>
                        <textarea type="text" className="h-28 rounded-lg focus:outline-none focus:border-purple-700 border-2 border-slate-200 focus:ring-blue-500/20 transition-all duration-200 p-3 mb-5 resize-none " placeholder="Describe what this deck is about..." name="description" ></textarea>
                    </div>
                    ...
                    <div>
                        <button className="bg-gradient-to-r from-violet-500 to-purple-400 text-white w-full h-12 rounded-xl" type="submit" >Add Deck</button>
                    </div>
                </div>
            </div>
        </form>
